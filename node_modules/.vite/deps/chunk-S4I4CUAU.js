...
var ICONS = {
  add: async () => (await import("./add-N4XI3RZV.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-GS5EP4Y3.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-N4LDDMTE.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-XIZRWKEN.js")).appStoreSvg,
  apple: async () => (await import("./apple-JEO27KYZ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-BVBGOLQY.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-5SAZOP5Z.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-MXML527A.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-7TVFQQN3.js")).arrowTopSvg,
  bank: async () => (await import("./bank-4FYLMBJX.js")).bankSvg,
  browser: async () => (await import("./browser-LF6PTFBF.js")).browserSvg,
  card: async () => (await import("./card-XRUVKL56.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-FW4LLT5B.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-NMQYFTK5.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-7Y55TRBI.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-EYZJPJB3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-WC7MTIVH.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-HSQRZKZK.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-IH6S5HWW.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-GVUJQHX3.js")).clockSvg,
  close: async () => (await import("./close-SG4KKPWJ.js")).closeSvg,
  compass: async () => (await import("./compass-L2XGACHP.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-UE2TGOQE.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-Z2MRKL7D.js")).copySvg,
  cursor: async () => (await import("./cursor-74OVP726.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-4NVSDROL.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-CFUDJK3G.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-JUSZOOZY.js")).disconnectSvg,
  discord: async () => (await import("./discord-JRH6EZOZ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-PCOG5PUK.js")).etherscanSvg,
  extension: async () => (await import("./extension-V4JDZZH7.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-DIIRPYOG.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-S2ESU53W.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-WHLDCIHI.js")).farcasterSvg,
  filters: async () => (await import("./filters-M4IWYRVC.js")).filtersSvg,
  github: async () => (await import("./github-WJEQ73FF.js")).githubSvg,
  google: async () => (await import("./google-N34PBIFH.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-OFP25KFB.js")).helpCircleSvg,
  image: async () => (await import("./image-KS6LDTJI.js")).imageSvg,
  id: async () => (await import("./id-3ESD6V3E.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-EERLMK7V.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-WASZ7YNN.js")).lightbulbSvg,
  mail: async () => (await import("./mail-X7NGOGF3.js")).mailSvg,
  mobile: async () => (await import("./mobile-QY57FMT7.js")).mobileSvg,
  more: async () => (await import("./more-CUMESMYP.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-ID4WFA4A.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-DK6PCHG3.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-DBGP6R65.js")).offSvg,
  playStore: async () => (await import("./play-store-BCZOEOV4.js")).playStoreSvg,
  plus: async () => (await import("./plus-4GAJGJGK.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-X43IOP3B.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-GWWRROFH.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-B664CNVG.js")).refreshSvg,
  search: async () => (await import("./search-3HVNVA3U.js")).searchSvg,
  send: async () => (await import("./send-Y27JZTKV.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-UABQZNFS.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-BFSWSOME.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-ZTMSSOJF.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-YGBRFQ4I.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-GWGSJPJP.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-G77MFGUV.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-EMVCNSQH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-TTORY7II.js")).twitchSvg,
  twitter: async () => (await import("./x-XVM3P45O.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-VCPDIOV3.js")).twitterIconSvg,
  verify: async () => (await import("./verify-5BEFGZGW.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-YIKEMYUG.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-CEMDBTFQ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-POKJHSR6.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-POKJHSR6.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-POKJHSR6.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SVLOLYOO.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-YLADHYSA.js")).warningCircleSvg,
  x: async () => (await import("./x-XVM3P45O.js")).xSvg,
  info: async () => (await import("./info-CCKK2PAN.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-BBMQRDWM.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-U5YTXMNW.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S4I4CUAU.js.map
