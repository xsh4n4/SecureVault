...
export declare const ConstantsUtil: {
    ...
    NATIVE_TOKEN_ADDRESS: {
        readonly evm: "0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee";
        readonly solana: "So11111111111111111111111111111111111111111";
    };
    CONVERT_SLIPPAGE_TOLERANCE: number;
    DEFAULT_FEATURES: {
        readonly swaps: true;
        readonly onramp: true;
        readonly analytics: true;
        readonly allWallets: "SHOW";
        readonly disableAppend: false;
        readonly enableEIP6963: false;
    };
};
